...
import boto3
from transcoder.secrets_key import SecretKeys
import subprocess

secret_keys = SecretKeys()

class VideoTrancoder:
    def __init__(self):
    ...
    def download_video(self, localpath):
    ...
    def upload_files(self, prefix: str, local_dir):
        for root, _, files in os.walk(local_dir):
            for file in files:
                ...
                s3_key = f"{prefix}/{os.path.realpath(local_path,local_dir)}"
